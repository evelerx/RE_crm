...
export default function DealDetailPage() {
  ...
  return (
    <div className="page">
      ...
      {deal ? (
        <nav className="dealTabs">
          <a href="#deal-snapshot">Snapshot</a>
          <a href="#deal-notes">Notes</a>
      ...
      {deal ? (
        <div className="detailGrid">
          <section className="card premiumPanel" id="deal-snapshot">
          ...
          <section className="card" id="deal-notes">
          ...
          <section className="card" id="deal-closure">
          ...
          <section className="card" id="deal-images">
          ...
          <section className="card" id="deal-ai">
          ...
          <section className="card" id="deal-activities">
